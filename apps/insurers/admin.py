...
class LeasingManagerAdmin(admin.ModelAdmin):
    list_display = ["name", "full_name", "branch", "phone", "email"]
    list_filter = ["branch"]
    search_fields = ["name", "full_name", "phone", "email", "branch__branch_name"]
    fields = ["name", "full_name", "branch", "phone", "email", "notes"]
