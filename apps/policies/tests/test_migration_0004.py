...
class TestMigration0004Functions:
    ...
    def test_forward_migration_transfers_data(self, db, client_factory, insurer_factory, 
                                             branch_factory, insurance_type_factory):
        """
    ...
    def test_reverse_migration_restores_data(self, db, client_factory, insurer_factory,
                                            branch_factory, insurance_type_factory):
        """
    ...
    def test_forward_migration_policy_without_payments(self, db, client_factory, 
                                                       insurer_factory, branch_factory, 
    ...
    def test_reverse_migration_policy_without_payments(self, db, client_factory,
                                                       insurer_factory, branch_factory,
                                                       insurance_type_factory):
        """
    ...
    def test_reverse_migration_different_insurance_sums(self, db, client_factory,
                                                       insurer_factory, branch_factory,
                                                       insurance_type_factory):
        """
