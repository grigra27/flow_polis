...
# snapshot отправки наравне с менеджерами филиала.
ALLIANCE_BACKUP_MANAGER_ID = 20
# Дополнительные адреса для альянс-писем по branch_id полиса. К менеджерам
# филиала + резервному менеджеру добавляются перечисленные адреса.
