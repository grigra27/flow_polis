...
Итого 25 задач: 9 × P0 (все PASS), 10 × P1 (5 CANCELLED — P1-01…04 + P1-09, 3 PASS — P1-06, P1-07, P1-10, 2 реализовано/не задеплоено — P1-05, P1-08), 6 × P2 (все pending). Дубликатов ID нет, нумерация в каждой группе непрерывна (P0-01…P0-09, P1-01…P1-10, P2-01…P2-06). Отменённые задачи сохраняют номер в реестре — не переиспользуется и не удаляется, чтобы решение оставалось прослеживаемым.
